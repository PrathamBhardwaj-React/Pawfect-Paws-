                ...
                <div className="col-md-4 d-flex ftco-animate">
                  <div className="blog-entry align-self-stretch">
                    ...
                    <div className="text p-4">
                      ...
                      <h3 className="heading">
                        <a href="https://youtu.be/OZY13WQjqhU?feature=shared">
                ...
                <div className="col-md-4 d-flex ftco-animate">
                  <div className="blog-entry align-self-stretch">
                    ...
                    <div className="text p-4">
                      ...
                      <h3 className="heading">
                        <a href="https://youtu.be/tNu4-G0SmRU">
                          Basic Pet Care: Cats(some important things)
                        </a>
                      </h3>
                    </div>
                  </div>
                ...
                <div className="col-md-4 d-flex ftco-animate">
                  <div className="blog-entry align-self-stretch">
                    ...
                    <div className="text p-4">
                      ...
                      <h3 className="heading">
                        <a href="https://youtu.be/Q6CyUeqHpGA?feature=shared">
